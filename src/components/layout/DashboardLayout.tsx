...
export const DashboardLayout = ({ children, activeTab, setActiveTab }: DashboardLayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex">
      {/* Sidebar */}
      <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} fixed inset-y-0 left-0 z-50 w-64 bg-gray-800 shadow-lg transition-transform duration-300 lg:translate-x-0 lg:static lg:inset-0 hover-glow`}>
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="lg:hidden hover-glow text-white"
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <Button
            variant="outline"
            className="w-full flex items-center space-x-2 hover-glow text-white border-gray-600 hover:bg-gray-700"
      ...
      <div className="flex-1 flex flex-col">
        {/* Header */}
        <header className="bg-gray-800 shadow-sm border-b border-gray-700 px-4 py-3 flex items-center justify-between hover-glow">
